...
1. **Bitwarden**-ში დააგენერირეთ **7 სიტყვიანი პაროლი**. დაარქვით სახელი, მაგ. "My windows laptop password" და შეინახეთ.
...
2. აირჩიეთ:
    ...
    ```powershell
    Enforce PIN Login (Disable Passwords)
    ```
...
განმარტება: იყენებს აპარატურულ შიფრაციას ოპერაციული სისტემისთვის.
///
...
განმარტება: საშუალებას იძლევა გადავიდეს პროგრამულ შიფრაციაზე, თუ აპარატურული შიფრაცია არ მუშაობს.
///
...
განმარტება: არ ზღუდავს აპარატურული შიფრაციის ალგორითმებს.
///

/// admonition | OSAllowedHardwareEncryptionAlgorithms (დაშვებული აპარატურული შიფრაციის ალგორითმები)
    type: info
- [x] ჩართული (EXSZ:2.16.840.1.101.3.4.1.2;2.16.840.1.101.3.4.1.42)

განმარტება: განსაზღვრავს დაშვებულ აპარატურული შიფრაციის ალგორითმებს.
///
...
განმარტება: არ იყენებს აღდგენის გასაღებს ფიქსირებული დისკებისთვის.
///
...
განმარტება: იყენებს აპარატურულ შიფრაციას ფიქსირებული დისკებისთვის.
///
...
განმარტება: საშუალებას იძლევა გადავიდეს პროგრამულ შიფრაციაზე, თუ აპარატურული შიფრაცია არ მუშაობს ფიქსირებული დისკებისთვის.
///
...
განმარტება: არ ზღუდავს აპარატურული შიფრაციის ალგორითმებს ფიქსირებული დისკებისთვის.
///
...
განმარტება: განსაზღვრავს დაშვებულ აპარატურული შიფრაციის ალგორითმებს ფიქსირებული დისკებისთვის.
///
