...
/// admonition | **გამოიყენეთ** Face ID და Touch ID
    type: success

:material-fingerprint:&nbsp; **Face ID** ან **Touch ID**-ის გათიშვა კომფორტის მნიშვნელოვნად შემცირების გარდა, უფრო მარტივი პაროლის გამოყენებისკენ გვიბიძგებს
...
:material-lock:&nbsp; მობილური მოწყობილობის უსაფრთხოება მისი **პაროლის სიმძლავრეზეა** დამოკიდებული. განსაკუთრებით მაშინ, როცა მოწყობილობა გამორთულია

:material-fingerprint-off:&nbsp; გამორთული მდგომარეობიდან პირველად ჩართვის შემდეგ, **Face ID** ან **Touch ID** ისედაც არ იმუშავებს იქამდე, სანამ პაროლს ერთხელ მაინც არ შეიყვანთ

:material-shield-check:&nbsp; ამიტომ უმჯობესია, გამოიყენოთ რთული პაროლი **Face ID** ან **Touch ID**-სთან ერთად და საფრთხის შემთხვევაში, მოწყობილობა უბრალოდ გათიშოთ
...
:material-key:&nbsp; სრული პაროლი უსაფრთხოდ შეინახეთ Bitwarden-ში, სადაც ის დაცულია თქვენი მთავარი პაროლით.
