...
პაროლის დასაგენერირებლად გამოიყენეთ **[FOI პაროლების გენერატორი](../tools/password-generator.md?os=android)**.

- **Bitwarden**-ში შექმენით ახალი ჩანაწერი, დაარქვით სახელი, მაგ. `My Pixel 9 Password`
- **[FOI პაროლების გენერატორით](../tools/password-generator.md?os=android)** დააგენერირეთ **Android Lock** ტიპის პაროლი, 
