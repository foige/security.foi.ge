...
2. შექმენით მთავარი პაროლი [FOI პაროლების გენერატორით](../tools/password-generator.md?os=bitwarden)
...
- პაროლის მენეჯერის პაროლი მხოლოდ თქვენ იცით - მისი აღდგენა შეუძლებელია!
///
