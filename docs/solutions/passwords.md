...
პაროლების მენეჯერი, ანგარიშის შექმნის შემდეგ, პაროლებს ავტომატურად დაგვიგენერირებს, მათ შორის სიტყვებსაც.
თუმცა, სანამ პაროლების მენეჯერი გვექნება, აუცილებელია მისი საკუთარი პაროლის მოფიქრებაც, რომელიც ასევე
შემთხვევითი წესით უნდა იყოს გენერირებული. 1Password თავის ვებგვერდზე უსასო გენერატორს გვთავაზობს,
